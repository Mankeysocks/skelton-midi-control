...
namespace sm {
    ...
    SymmetryAnalyzer::SymmetryAnalyzer(UserSkeleton* usr, JointType lftJntTyp, JointType rghtJntTyp)
    : user(usr)
    , leftJointType(lftJntTyp)
    , rightJointType(rghtJntTyp)
    {
        
    }
    
    void SymmetryAnalyzer::clockCallback(int clock)
    {        
